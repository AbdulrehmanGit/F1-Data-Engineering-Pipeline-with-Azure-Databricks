...
from driver_standings where race_year = 2018
...
as select
race_year, driver_name, team, total_points, wins, rank
from driver_standings where race_year = 2020
...
select 
 * from v_driver_standings_2020 d_2020

 join v_driver_standings_2018 d_2018
